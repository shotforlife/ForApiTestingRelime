@ST_4663 @tagtagtag @this_is_story_tag
...
@SC_30800 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_30801 @third_scenario_tag
...
@SC_30802 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_30803 @fifth_scenario_tag
